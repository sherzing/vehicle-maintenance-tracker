 ...
 * - Sets all maintenance items' last_serviced_date and last_serviced_usage to null
 *
 * @param {string} vehicleId - Vehicle ID to reset
 * @returns {Promise<Object>} Result with counts of deleted/reset items
 */
export async function resetVehicleHistory(vehicleId) {
  try {
    ...
    // 3. Reset all maintenance items to null last serviced values
